...
- Description: Authenticated application shell with a dark expandable sidebar, top header, global search, theme action, user menu, navigation tab, and router content area.
