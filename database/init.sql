...
CREATE TABLE IF NOT EXISTS mfg_routing (
  ...
  UNIQUE KEY uk_mfg_routing_bom_version (org_id, bom_id, routing_version)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS mfg_routing_operation (
  ...
  KEY idx_mfg_routing_operation_center (work_center_id),
  UNIQUE KEY uk_mfg_routing_operation_line (routing_id, line_no)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS mfg_work_report (
  ...
  KEY idx_mfg_work_report_operation (operation_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS biz_document (
  ...
  KEY idx_biz_document_department (department_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS sys_org_membership (
  id CHAR(36) PRIMARY KEY, user_id CHAR(36) NOT NULL, org_id CHAR(36) NOT NULL,
  membership_type VARCHAR(32) NOT NULL DEFAULT 'member', is_default TINYINT(1) NOT NULL DEFAULT 0,
  status VARCHAR(32) NOT NULL DEFAULT 'active', is_deleted TINYINT(1) NOT NULL DEFAULT 0,
  version INT NOT NULL DEFAULT 1, created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  UNIQUE KEY uk_sys_org_membership_user_org (user_id, org_id), KEY idx_sys_org_membership_org (org_id, status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS ext_event_subscription (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, name VARCHAR(128) NOT NULL, endpoint_url VARCHAR(500) NOT NULL,
  event_types JSON NOT NULL, secret_hash VARCHAR(128) NOT NULL, signing_secret VARCHAR(255) NOT NULL,
  status VARCHAR(32) NOT NULL DEFAULT 'active', failure_count INT NOT NULL DEFAULT 0,
  is_deleted TINYINT(1) NOT NULL DEFAULT 0, version INT NOT NULL DEFAULT 1,
  created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  UNIQUE KEY uk_ext_event_subscription_name (org_id, name), KEY idx_ext_event_subscription_org (org_id, status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS ext_event_delivery (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, event_id CHAR(36) NOT NULL, subscription_id CHAR(36) NOT NULL,
  status VARCHAR(32) NOT NULL DEFAULT 'pending', attempt_count INT NOT NULL DEFAULT 0, response_status INT NULL,
  response_body VARCHAR(1000) NULL, delivered_at DATETIME(6) NULL, is_deleted TINYINT(1) NOT NULL DEFAULT 0,
  ...
  UNIQUE KEY uk_ext_event_delivery_event_subscription (event_id, subscription_id), KEY idx_ext_event_delivery_org (org_id, status), KEY idx_ext_event_delivery_event (event_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS fin_currency (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, code VARCHAR(8) NOT NULL, name VARCHAR(64) NOT NULL, symbol VARCHAR(8) NULL,
  decimal_places INT NOT NULL DEFAULT 2, is_base TINYINT(1) NOT NULL DEFAULT 0, status VARCHAR(32) NOT NULL DEFAULT 'active',
  ...
  updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE KEY uk_fin_currency_org_code (org_id, code), KEY idx_fin_currency_org (org_id, status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS fin_exchange_rate (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, base_currency VARCHAR(8) NOT NULL, quote_currency VARCHAR(8) NOT NULL,
  rate_date DATE NOT NULL, rate DECIMAL(18,8) NOT NULL, source VARCHAR(64) NOT NULL DEFAULT 'manual', is_deleted TINYINT(1) NOT NULL DEFAULT 0,
  version INT NOT NULL DEFAULT 1, created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  UNIQUE KEY uk_fin_exchange_rate_day (org_id, base_currency, quote_currency, rate_date), KEY idx_fin_exchange_rate_lookup (org_id, base_currency, quote_currency, rate_date)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
INSERT INTO sys_schema_migration (version, description)
...
CREATE TABLE IF NOT EXISTS biz_report_definition (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, report_key VARCHAR(64) NOT NULL,
  name VARCHAR(128) NOT NULL, description VARCHAR(500) NOT NULL DEFAULT '', parameters_json JSON NOT NULL,
  status VARCHAR(32) NOT NULL DEFAULT 'active', owner_id CHAR(36) NOT NULL, is_deleted TINYINT(1) NOT NULL DEFAULT 0,
  version INT NOT NULL DEFAULT 1, created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  UNIQUE KEY uk_biz_report_definition_org_key (org_id, report_key), KEY idx_biz_report_definition_org_status (org_id, status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS biz_report_run (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, report_definition_id VARCHAR(64) NOT NULL,
  report_key VARCHAR(64) NOT NULL, requested_by CHAR(36) NOT NULL, parameters_json JSON NOT NULL,
  status VARCHAR(32) NOT NULL DEFAULT 'completed', result_json JSON NOT NULL, error_message VARCHAR(500) NULL,
  is_deleted TINYINT(1) NOT NULL DEFAULT 0, version INT NOT NULL DEFAULT 1,
  created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  KEY idx_biz_report_run_org_created (org_id, created_at), KEY idx_biz_report_run_report (org_id, report_key, status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
INSERT INTO sys_menu (id, parent_id, code, name, path, component, menu_type, sort_order)
...
-- P0 execution control tables
CREATE TABLE IF NOT EXISTS inv_pick_wave (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, wave_no VARCHAR(64) NOT NULL, warehouse_id CHAR(36) NOT NULL,
  status VARCHAR(32) NOT NULL DEFAULT 'draft', priority INT NOT NULL DEFAULT 50, assigned_to CHAR(36) NULL,
  released_at DATETIME NULL, completed_at DATETIME NULL, is_deleted TINYINT(1) NOT NULL DEFAULT 0, version INT NOT NULL DEFAULT 1,
  created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
...
CREATE TABLE IF NOT EXISTS inv_warehouse_task (
  ...
  material_id CHAR(36) NULL, batch_id CHAR(36) NULL, planned_quantity DECIMAL(18,6) NOT NULL DEFAULT 0, completed_quantity DECIMAL(18,6) NOT NULL DEFAULT 0,
  assigned_to CHAR(36) NULL, wave_id CHAR(36) NULL, status VARCHAR(32) NOT NULL DEFAULT 'ready', priority INT NOT NULL DEFAULT 50,
  exception_reason VARCHAR(500) NULL, completed_at DATETIME NULL, completed_by CHAR(36) NULL, is_deleted TINYINT(1) NOT NULL DEFAULT 0, version INT NOT NULL DEFAULT 1,
  created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  UNIQUE KEY uk_inv_warehouse_task_no (org_id, task_no), KEY idx_inv_warehouse_task_scope (org_id, warehouse_id, status), KEY idx_inv_warehouse_task_wave (wave_id),
  CONSTRAINT fk_inv_task_wave FOREIGN KEY (wave_id) REFERENCES inv_pick_wave(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS mfg_work_order_schedule (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, work_order_id CHAR(36) NOT NULL, operation_id CHAR(36) NULL, work_center_id CHAR(36) NOT NULL,
  schedule_date DATE NOT NULL, scheduled_hours DECIMAL(18,6) NOT NULL, actual_hours DECIMAL(18,6) NOT NULL DEFAULT 0, status VARCHAR(32) NOT NULL DEFAULT 'planned', created_by CHAR(36) NULL,
  is_deleted TINYINT(1) NOT NULL DEFAULT 0, version INT NOT NULL DEFAULT 1, created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
...
CREATE TABLE IF NOT EXISTS mfg_alternate_material (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, work_order_id CHAR(36) NOT NULL, material_id CHAR(36) NOT NULL, alternate_material_id CHAR(36) NOT NULL,
  conversion_rate DECIMAL(18,6) NOT NULL DEFAULT 1, status VARCHAR(32) NOT NULL DEFAULT 'approved', reason VARCHAR(255) NULL, approved_by CHAR(36) NULL,
  is_deleted TINYINT(1) NOT NULL DEFAULT 0, version INT NOT NULL DEFAULT 1, created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
...
CREATE TABLE IF NOT EXISTS mfg_work_order_exception (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, work_order_id CHAR(36) NOT NULL, exception_type VARCHAR(64) NOT NULL, description VARCHAR(500) NOT NULL,
  status VARCHAR(32) NOT NULL DEFAULT 'open', occurred_at DATETIME NOT NULL, reported_by CHAR(36) NULL, resolved_at DATETIME NULL, resolved_by CHAR(36) NULL, resolution VARCHAR(500) NULL,
  is_deleted TINYINT(1) NOT NULL DEFAULT 0, version INT NOT NULL DEFAULT 1, created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  KEY idx_mfg_exception_order_status (org_id, work_order_id, status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS fin_budget (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, budget_period CHAR(7) NOT NULL, account_code VARCHAR(64) NOT NULL, department_id CHAR(36) NULL,
  budget_amount DECIMAL(18,2) NOT NULL, actual_amount DECIMAL(18,2) NOT NULL DEFAULT 0, status VARCHAR(32) NOT NULL DEFAULT 'draft', note VARCHAR(255) NULL,
  is_deleted TINYINT(1) NOT NULL DEFAULT 0, version INT NOT NULL DEFAULT 1, created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
...
CREATE TABLE IF NOT EXISTS fin_cash_forecast (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, forecast_date DATE NOT NULL, inflow_amount DECIMAL(18,2) NOT NULL DEFAULT 0, outflow_amount DECIMAL(18,2) NOT NULL DEFAULT 0,
  net_amount DECIMAL(18,2) NOT NULL DEFAULT 0, source VARCHAR(64) NOT NULL DEFAULT 'manual', status VARCHAR(32) NOT NULL DEFAULT 'draft', note VARCHAR(255) NULL,
  is_deleted TINYINT(1) NOT NULL DEFAULT 0, version INT NOT NULL DEFAULT 1, created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  UNIQUE KEY uk_fin_cash_forecast_day (org_id, forecast_date)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS fin_reconciliation_statement (
  id CHAR(36) PRIMARY KEY, org_id CHAR(36) NOT NULL, statement_no VARCHAR(64) NOT NULL, statement_type VARCHAR(8) NOT NULL, party_id CHAR(36) NOT NULL, period CHAR(7) NOT NULL,
  statement_amount DECIMAL(18,2) NOT NULL DEFAULT 0, reconciled_amount DECIMAL(18,2) NOT NULL DEFAULT 0, status VARCHAR(32) NOT NULL DEFAULT 'draft', note VARCHAR(255) NULL,
  is_deleted TINYINT(1) NOT NULL DEFAULT 0, version INT NOT NULL DEFAULT 1, created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
