...
.defect-dialog-scroll { max-height: min(68vh, 680px); overflow-y: auto; scrollbar-width: none; -ms-overflow-style: none; }
.defect-dialog-scroll::-webkit-scrollbar { display: none; width: 0; height: 0; }
