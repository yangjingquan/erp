  ...
  routes: [
    ...
    { path: "/403", name: "forbidden", component: () => import("../views/Forbidden.vue") },
    {
      ...
      children: [
        ...
        { path: "operations/advanced", name: "operations-advanced", component: () => import("../views/operations/AdvancedOperationsCenter.vue"), meta: { requiresAuth: true, permission: "operations:view" } },
        ...
        { path: "finance/foundation", name: "finance-foundation", component: () => import("../views/finance/FinanceFoundation.vue"), meta: { requiresAuth: true, permission: "finance:view" } },
        { path: "finance/currencies", name: "finance-currencies", component: () => import("../views/finance/CurrencySettings.vue"), meta: { requiresAuth: true, permission: "finance:view" } },
        { path: "finance/controls", name: "finance-controls", component: () => import("../views/finance/FinanceControls.vue"), meta: { requiresAuth: true, permission: "finance:view" } },
        ...
        { path: "crm/customer-360", name: "crm-customer-360", component: () => import("../views/crm/Customer360.vue"), meta: { requiresAuth: true, permission: "crm:view" } },
        { path: "plm/changes", name: "plm-changes", component: () => import("../views/plm/PlmChangeCenter.vue"), meta: { requiresAuth: true, permission: "production:view" } },
        { path: "srm/collaboration", name: "srm-collaboration", component: () => import("../views/srm/SupplierCollaboration.vue"), meta: { requiresAuth: true, permission: "purchase:view" } },
        { path: "projects/cost", name: "projects-cost", component: () => import("../views/projects/ProjectCostCenter.vue"), meta: { requiresAuth: true, permission: "cost:view" } },
        { path: "eam/service", name: "eam-service", component: () => import("../views/eam/AssetServiceCenter.vue"), meta: { requiresAuth: true, permission: "production:view" } },
        { path: "platform/group", name: "platform-group", component: () => import("../views/platform/GroupManagement.vue"), meta: { requiresAuth: true, permission: "config:view" } },
        { path: "platform/compliance", name: "platform-compliance", component: () => import("../views/platform/ComplianceCenter.vue"), meta: { requiresAuth: true, permission: "config:view" } },
        { path: "platform/low-code", name: "platform-low-code", component: () => import("../views/platform/LowCodeWorkbench.vue"), meta: { requiresAuth: true, permission: "config:view" } },
        { path: "platform/metrics", name: "platform-metrics", component: () => import("../views/platform/MetricAssistant.vue"), meta: { requiresAuth: true, permission: "dashboard:view" } },
        ...
        { path: "inventory/wms-tasks", name: "inventory-wms-tasks", component: () => import("../views/inventory-advanced/WmsTaskCenter.vue"), meta: { requiresAuth: true, permission: "inventory:view" } },
        ...
        { path: "production/planning", name: "production-planning", component: () => import("../views/production/PlanningControlTower.vue"), meta: { requiresAuth: true, permission: "production:view" } },
        ...
        { path: "production/execution", name: "production-execution", component: () => import("../views/production/ExecutionControl.vue"), meta: { requiresAuth: true, permission: "production:view" } },
        { path: "production/subcontract", name: "production-subcontract", component: () => import("../views/production/SubcontractList.vue"), meta: { requiresAuth: true, permission: "production:view" } },
        ...
        { path: "quality/analytics", name: "quality-analytics", component: () => import("../views/quality/QualityAnalyticsCenter.vue"), meta: { requiresAuth: true, permission: "quality:view" } },
        { path: "hr/employees", name: "hr-employees", component: () => import("../views/hr/EmployeeList.vue"), meta: { requiresAuth: true, permission: "hr:view" } },
        { path: "hr/people-ops", name: "hr-people-ops", component: () => import("../views/hr/HrPeopleOperations.vue"), meta: { requiresAuth: true, permission: "hr:view" } },
        { path: "hr/leave", name: "hr-leave", component: () => import("../views/hr/LeaveRequestCenter.vue"), meta: { requiresAuth: true, permission: "hr:view" } },
        ...
        { path: "settings/platform-events", name: "platform-events", component: () => import("../views/settings/PlatformEvents.vue"), meta: { requiresAuth: true, permission: "config:manage" } },
        ...
        { path: "workflow/tasks", name: "workflow-tasks", component: () => import("../views/workflow/MyTasks.vue"), meta: { requiresAuth: true, permission: "workflow:approve" } },
        ...
        { path: "documents", name: "unified-document-center", component: () => import("../views/UnifiedDocumentCenter.vue"), meta: { requiresAuth: true } },
      ],
    },
  ],
});
